...
def _setup_otel_instrumentation(settings: AgentServerSettings) -> None:
    ...
    if is_otel_enabled():
        ...
        instrumentation = InstrumentationSettings(
            ...
            version=settings.otel_instrumentation_version,  # ty: ignore[invalid-argument-type]  # type: ignore[arg-type]
        )
...
def create_agent_server(
    ...
    if not settings:
        settings = AgentServerSettings()  # ty: ignore[missing-argument]  # type: ignore[call-arg]
